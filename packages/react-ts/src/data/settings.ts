...
export const settings: partnerSettingsList = {
  ...
  haz: {
    ...
    prodSubTemplate: {
      subject: 'Activate Digital Service for Carzato 1163477',
      content: [
        'Please activate Digital data service for Carzato 1163477',
        '',
        'Billing Date: Activation Date',
        '',
        'New Method:',
        'DRSFDCBD $0 monthly',
        'CBDSUITEST as a OTC of $75 per store',
        '',
        'Bill to/ Sold to and Payer is: Carzato 1163477 Carzato',
        '2600 Mission Street',
        'San Marino, CA 91108',
        'United States',
        '',
